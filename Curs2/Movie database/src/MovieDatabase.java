...
public class MovieDatabase {
	...
	public static void main(String args[]) {
		...
		Studio studio3 = new Studio("Paramount", new Film[] {film3,film4,});
		Studio studio4 = new Studio("Universal", new Film[] {film4});


        //"Bazele de date" cu studiouri si actori
		Studio[] studioDatabase = new Studio[] {studio1, studio2,studio3,studio4};
		Film[] filmDatabase = new Film[] {film1, film2, film3, film4,film5};

		Studio test = new Studio();
		Film film = new Film();
		
		test.studioWithMinimum2Movies(studioDatabase);
		System.out.println();
		film.moviesWithCertainActor(filmDatabase, "actor fara oscar 01");
		System.out.println();
		film.moviesWihActorAboveFifty(filmDatabase);
